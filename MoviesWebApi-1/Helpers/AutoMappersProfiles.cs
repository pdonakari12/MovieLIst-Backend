...
namespace MoviesWebApi_1.Helpers
{
    public class AutoMappersProfiles:Profile
    {
        ...
        private List<ActorsMovieDTO> MapMoviesActors(Movie movie,MoviesDTO moviesDTO)
        {
        ...
        private List<MovieTheaterDTO> MapMovieTheatersMovies(Movie movie,MoviesDTO moviesDTO)
        {
        ...
        private List<GenreDTO> MapMoviesGenres(Movie movie,MoviesDTO movieDTO)
        {
